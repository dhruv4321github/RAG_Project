...
| **AI/LLM**  | LangChain, OpenAI (GPT-4 / GPT-3.5) or any OpenAI-compatible API |
...
User asks: "What is the client's risk tolerance?"
        │
        ▼
  Embed the query → 1536-dim vector
        │
        ▼
...
- [ ] **Open-Source LLM Support**: Swap in Llama 3, Mistral, etc. via Ollama
